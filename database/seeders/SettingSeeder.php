    ...
    public function run()
    {
        ...
        if ($customers && $purchaser && $warehouse) {
            ...
            Setting::insertOrIgnore([
                [
                    'key' => 'about_us',
                    'value' => 'Rawal is a clothing brand offers more than 100+ International brands at 20%-70% discount, all 365 days a year. We offer customers a wide range of brands and categories at absolutely great prices in an ambience that is refreshingly enjoyable. ',
