...
export default {
    ...
    methods: {
        fetchorders(page_url) {
            ...
            let vm = this;
            page_url = page_url || "/api/admin/order/"+this.$route.params.id+'?orderDetail=1&productDetail=1&currency=1&billing_country=1&billing_state=1&delivery_country=1&delivery_state=1';
