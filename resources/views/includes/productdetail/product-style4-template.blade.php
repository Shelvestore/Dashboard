                ...
                <div class="col-12 col-lg-4">
                    <div class="slider-wrapper slider-banner pd2">
                        <div class="slider-for">
                          <a class="slider-for__item ex1 fancybox-button product-detail-section-image-link" href="" data-fancybox-group="fancybox-button" title="Lorem ipsum dolor sit amet">
                                    ...
                                    <div class="review-bubble-single">
                                        <div class="review-bubble-bg">
                                          ...
                                          <fieldset class="ratings">
                                              ...
                                              <input type="radio" id="star05" name="rating0" value="5" class="rating">
                                              <label class="full" for="star05" title="Awesome0 - 5 stars"></label>


                                              <input type="radio" id="star04" name="rating0" value="4" class="rating">
                                              <label class="full" for="star04" title="Pretty0 good - 4 stars"></label>

                                              <input type="radio" id="star03" name="rating0" value="3" class="rating">
                                              <label class="full" for="star03" title="Pretty0 good - 3 stars"></label>

                                              <input type="radio" id="star02" name="rating0" value="2" class="rating">
                                              <label class="full" for="star02" title="Meh0 - 2 stars"></label>

                                              <input type="radio" id="star01" name="rating0" value="1" class="rating">
