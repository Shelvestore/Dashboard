...
<header id="headerOne" class="header-area header-one  header-desktop d-none d-lg-block d-xl-block">
  ...
  <div class="header-navbar bg-menu-bar">
    <div class="col-md-12" > <h3 style="text-align:center; letter-spacing: 16px;font-size 35px;">FROM       SAUDI      ARABIA       TO      ALL       OVER      THE        WORLD </h3></div>
      <div class="col-md-12" style="background-image: url({{ asset('/gallary/top-img.png')}}); padding:8px;">  </div>
...
<div class="col-md-3">
          ...
          <a href="{{url('/')}}" class="logo" data-toggle="tooltip" data-placement="bottom" title="{{isset(getSetting()['site_name']) ? getSetting()['site_name'] : 'Logo' }}">
            <img class="img-fluid" style="margin-top: 50px;" width="40%"; src="{{isset(getSetting()['site_logo']) ? getSetting()['site_logo'] : asset('01-logo.png') }}" alt="{{isset(getSetting()['site_name']) ? getSetting()['site_name'] : 'Logo' }}">
            
          </a>

    </div>
    <div class="col-md-3">
    <img class="img-fluid" style="margin-top: 50px;" width="24%"; src="{{ asset('/gallary/arabic.png')}}">
    <img class="img-fluid" style="margin-top: 50px;" width="26%"; src="{{ asset('/gallary/sar.png')}}">
   
    <img class="img-fluid" style="margin-top: 50px;" width="23%"; src="{{ asset('/gallary/search.png')}}">
    <img class="img-fluid" style="margin-top: 50px;" width="20%"; src="{{ asset('/gallary/user.png')}}">
               <img class="img-fluid" style="margin-top: 20px;" width="100%"; src="{{ asset('/gallary/payoptions.png')}}">
       </div>
    </div>
