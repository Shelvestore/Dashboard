        ...
        <nav class="nav flex-column">
          <a class="nav-link " style="color:black !important;font-size: 19px;font-family: 'Montserrat-Regular';padding: 10px;" href="{{$link}}">
                <?php $index = 0; ?>
        ...
        <li class="nav-item dropdown" style="color:black">
          <a class="nav-link dropdown-toggle" style="color:black" href="{{$link}}">
                <?php $index = 0; ?>
                @if(isset($menu[$menuloop]['language_id']))
                @php $index = array_search($data['selectedLenguage'],$menu[$menuloop]['language_id']) @endphp
                @endif
