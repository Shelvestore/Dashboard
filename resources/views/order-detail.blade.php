                    ...
                    <div class="col-12 col-sm-12">
                        <div class="comments-area">
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">{{ trans('lables.order-detail-comments') }}</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="{{ trans('lables.order-detail-comments') }}"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
